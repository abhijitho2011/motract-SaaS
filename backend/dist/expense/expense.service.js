...
let ExpenseService = class ExpenseService {
    ...
    async createExpense(data) {
        const [expense] = await this.db.insert(schema_1.expenses).values({
            ...data,
            id: crypto.randomUUID(),
        }).returning();
        return expense;
    }
    async getExpenses(workshopId) {
        return this.db.query.expenses.findMany({
            where: (0, drizzle_orm_1.eq)(schema_1.expenses.workshopId, workshopId),
