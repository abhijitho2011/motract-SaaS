...
class _OrganizationDetailsScreenState extends State<OrganizationDetailsScreen> {
  ...
  Future<void> _loadOrganization() async {
    try {
      ...
      final org = await ApiClient.getOrganization(widget.organizationId);
  ...
  Future<void> _deleteOrganization() async {
    ...
    try {
      await ApiClient.deleteOrganization(widget.organizationId);
      if (mounted) {
  ...
  Widget _buildDetails() {
    if (_organization == null) return const SizedBox();
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            if (org['subCategory'] != null)
                              Chip(label: Text(org['subCategory'])),
                            if (isAuthorized)
                              const Chip(
